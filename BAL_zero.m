...
elseif length(AoS0unique)>1 && length(AoA0unique)==1 
   ...
   disp('Both AoA and AoS varied in same zero run. Program will only work if single zero run is used per data file. Polynomial regression used to define 0 offsets. Check response model with raw zero data.')   
